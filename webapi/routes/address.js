...
// URL: http://fiyo.click/api/address
...
// URL: http://fiyo.click/api/address?user_id=64531a...
...
// URL: http://fiyo.click/api/address/user/:userId
router.get('/user/:userId', async (req, res) => {
  try {
...
// URL: http://fiyo.click/api/address/:id
...
// [POST] Tạo địa chỉ
// URL: http://fiyo.click/api/address/create
